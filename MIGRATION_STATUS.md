...
## Completed
- SDF ray-marched G-Buffer is active via the fullscreen GBuffer pass (`gBuffer.frag` uses `GetDistMat` + `GetMaterial`) and is wired into ReSTIR/lighting through existing G-Buffer bindings.
